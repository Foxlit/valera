...
Сценарий: сброс пароля пользователя
	И Я открываю навигационную ссылку "e1cib/data/Справочник.Пользователи?ref=83680030488eafbf11de194205bdda24"
	Когда открылось окно "Коновалова Наталия (Пользователь)"
	И я нажимаю на кнопку с именем 'СменитьПароль'
	Когда открылось окно "Установка пароля"
	И в поле с именем 'НовыйПароль' я ввожу текст "1q2w3e$R%T^Y0o9i8u&Y^T%R"
	И в поле с именем 'Подтверждение' я ввожу текст "1q2w3e$R%T^Y0o9i8u&Y^T%R"
	И я нажимаю на кнопку с именем 'ФормаУстановитьПароль'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	И я жду закрытия окна "Коновалова Наталия (Пользователь) *" в течение 20 секунд
	И я закрываю TestClient "Этот клиент"
...
* Дата отгрузки
	...
	Когда открылось окно "Введите дату отгрузки"
