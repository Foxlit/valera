...
//	И я выполняю код встроенного языка на сервере
//		"""bsl
//			Штрихкод = ШтрихкодированиеПечатныхФорм.ЧисловойКодПоСсылке('bfb000155d755e0011efe465bb24e427');
//
//		"""
...
* Выбор заказа
	...
	И в поле с именем 'InputFld' я ввожу текст "248757185448659261114667180027138104832"
	...
	Тогда таблица 'Товары' стала равной:																															
		...
		| '$$НоменклатураТовара$$'  | '5 / 5 шт (по распоряжению 5), $$ЯчейкаТовара$$' |
