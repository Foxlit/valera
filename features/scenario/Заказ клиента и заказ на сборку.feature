...
* Штрихкод распоряжения
	И я выполняю код встроенного языка на сервере
		"""bsl
			Штрихкод = ШтрихкодированиеПечатныхФорм.ЧисловойКодПоСсылке("$$НавигационнаяСсылкаОкна$$");
		"""
...
* Выбор заказа
	...
	И в поле с именем 'InputFld' я ввожу текст "121953887222076471217595867085915119104"
