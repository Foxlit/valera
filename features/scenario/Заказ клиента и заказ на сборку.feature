...
Сценарий: Сброс пароля пользователя и подключение его
...
Сценарий: Создание Заказа клиента и сборки
	...
	* Доставка
			...
			И я жду закрытия окна "Реализация товаров и услуг FATR-004162 от *" в течение 20 секунд
...
Сценарий: Вход под оператором ТСД
