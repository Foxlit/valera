...
* Заполнение шапки документа
	...
	Когда открылось окно "Выбор объекта расчетов с поставщиком"
	И в таблице "ОбъектыРасчетов" я перехожу к следующей строке
	...
	И в поле с именем 'Pattern' я ввожу текст "FATR-000313"
